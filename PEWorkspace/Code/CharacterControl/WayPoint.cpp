...
namespace CharacterControl{
	namespace Events {
		...
		//Event_CREATE_WAYPOINT::Event_CREATE_WAYPOINT(std::string name, std::string nextWayPointName, Vector3 pos, Vector3 u, Vector3 v, Vector3 n,
		//	PEUUID peuuid)
		//{
...
//WayPoint::WayPoint(Vector3 u, Vector3 v, Vector3 n, Vector3 pos, char* name, char* nextWayPointName)
//{
//	m_base.loadIdentity();
//	m_base.setPos(pos);
//	m_base.setU(u);
...
//	m_base.setN(n);
//
//	StringOps::writeToString(name, m_name, 32);
//	StringOps::writeToString(nextWayPointName, m_nextWayPointName, 32);
//}
